...
describe('Shipment e2e test', () => {
  ...
  // const shipmentSample = {"date":"2023-02-20T15:53:40.261Z"};
  ...
  beforeEach(() => {
    ...
    cy.authenticatedRequest({
      method: 'POST',
      url: '/api/invoices',
      body: {"code":"robust scale","date":"2023-02-21T08:35:40.314Z","details":"withdrawal sensor","status":"PAID","paymentMethod":"CREDIT_CARD","paymentDate":"2023-02-20T14:19:40.996Z","paymentAmount":16937},
    }).then(({ body }) => {
      invoice = body;
    });
  });
  ...
  describe('new Shipment page', () => {
    ...
    it.skip('should create an instance of Shipment', () => {
      ...
      cy.get(`[data-cy="date"]`).type('2023-02-20T17:19').blur().should('have.value', '2023-02-20T17:19');
