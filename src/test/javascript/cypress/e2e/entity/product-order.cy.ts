...
describe('ProductOrder e2e test', () => {
  ...
  // const productOrderSample = {"placedDate":"2023-02-21T01:17:58.174Z","status":"COMPLETED","code":"Shoes Corners initiatives"};
  ...
  describe('new ProductOrder page', () => {
    ...
    it.skip('should create an instance of ProductOrder', () => {
      cy.get(`[data-cy="placedDate"]`).type('2023-02-21T06:38').blur().should('have.value', '2023-02-21T06:38');
